...
def test_canonical_results_preserve_observed_values_and_boundaries() -> None:
    ...
    assert CANONICAL_RESULTS["rhythm_primary8"].release_role == "primary8_candidate"
    ...
    assert CANONICAL_RESULTS["rhythm_primary6_diagnostic"].release_role == "primary6_diagnostic"
    ...
    assert p4.release_role == "primary4_pathology"
