...
5. Keep validation data names, class orders, thresholds, and metric definitions explicit.
6. Keep Primary8, Primary6 diagnostic, and Primary4 as separate release profiles.
